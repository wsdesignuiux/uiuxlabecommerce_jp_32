...
import e.wolfsoft1.uiuxlabecommerce_jp_32.R;
import e.wolfsoft1.uiuxlabecommerce_jp_32.model.Color_Model;

public class ColorAdapter_32 extends RecyclerView.Adapter<ColorAdapter_32.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model> color_modelArrayList;
    private int position;

    public ColorAdapter_32(Context context, ArrayList<Color_Model> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_32, viewGroup, false);
