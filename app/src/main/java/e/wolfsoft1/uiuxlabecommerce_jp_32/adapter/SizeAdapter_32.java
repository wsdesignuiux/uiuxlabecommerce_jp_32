...
public class SizeAdapter_32 extends RecyclerView.Adapter<SizeAdapter_32.MySizeHolder> {

    private final ArrayList<Size_Model> size_modelArrayList;
    private final Context context;
    private int position;

    public SizeAdapter_32(Context context, ArrayList<Size_Model> size_modelArrayList) {
    ...
    public MySizeHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_size_32, viewGroup, false);
